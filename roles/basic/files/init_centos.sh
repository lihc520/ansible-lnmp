#!/bin/bash
###
 # @Author: eddie eddie@wizmacau.com
 # @Date: 2023-02-21 16:34:10
 # @LastEditors: eddie eddie@wizmacau.com
 # @LastEditTime: 2023-04-13 14:57:38
 # @FilePath: /ansible-roles/plays/files/init_centos.sh
